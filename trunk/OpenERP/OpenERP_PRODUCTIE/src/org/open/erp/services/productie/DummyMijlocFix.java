...
public class DummyMijlocFix {
	...
	public DummyMijlocFix(Integer id, String denumire, String adresa, Integer valoare, Integer termenExploatare) {
		super();
