...
*/	
	...
	public void testVerificareStocCurent() throws Exception{
		...
		Articol art1 = new Articol(1, 0.00, gest1, produs1, new ArrayList<Loturi>());
		Articol art2 = new Articol(2, 0.00, gest1, produs2, new ArrayList<Loturi>());
		logger.info("FINAL creare articole----- ");
		
		logger.info("START creare loturi----- ");
		Loturi lot1 = new Loturi(1, produs1.getCantitate(), produs1.getPretIntrare(), new Date());
		Loturi lot2 = new Loturi(2, produs1.getCantitate(), produs1.getPretIntrare(), new Date());
		Loturi lot3 = new Loturi(3, produs2.getCantitate(), produs2.getPretIntrare(), new Date());
		Loturi lot4 = new Loturi(4, produs2.getCantitate(), produs2.getPretIntrare(), new Date());
		art1.addLot(lot1);
		art1.addLot(lot2);
		art2.addLot(lot3);
		art2.addLot(lot4);
		...
		if (val !=null){
			logger.info("Valoarea cantitatii produsului: "+produs1.getNumeProdus() + " este de: " + val );
		}
		else {
			logger.info("Produsului: "+produs1.getNumeProdus() + " nu a fost gasit.");
		}	
	}	
}
