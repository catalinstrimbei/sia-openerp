 ...
 * 1. Creaza instanta centru cost
 * 2. Alocare costuri
 * *. Returneata centruCost initializat in IN_ALOCARE
 *  
 * @UseCase("initiere centru cost"):
 *  
 */
...
public interface CentruCostSRV {
	 ...
	 * 
	 * @param nume 			Denumirea centrului de cost nou creat
	 * @param responsabil 	Numele persoanei responsabila pe centru de cost
	 * @param dataStart 	Data start conform fazei de productie
	 * @param dataSfarsit 	Data sfarsit conform fazei de productie
	 * @param ValoareCost 	Valoarea costului (din CosturiPrimare)
	 * 
	 ...
	 * @param dataStart
	 * @param dataSfarsit
	 * @param valoareAprovizionareExterna (din LinieCost)
	 * 
	 ...
	 * 
	 * @param centruCost		Centrul de cost a carui derulare va fi initiata
	 * 
	 * @return 
	 * 
	 */	
	...
	/**
	 * Scop					Schimba status centru cost in progress, actualizeaza activitate, actualizeaza liniie de cost ale centrului de cost
	 * 
	 * @param nume 			denumireActivitate in progres.
	 * 
	 * @return 
	 * 
	 */	
	...
	void progresActivitate(Activitate activitate, Double procent, Double costTotal, Date dataActualizata);
	/**
	 * Scop					Calculeaza sold centrului de cost de la inceput pina la data actualizarii
	 * 
	 * @param centruCost 		CentruCost in progres.
	 * @param centruCost 		Data referinta sold.
	 * 	
