...
public class ProjectDummyFactory {
	...
	/*
	 * eliminat depententa prin observer pattern public static AprovizionareSrv
	 * getAprovizionareSrv( ){
	 * logger.loggeazaINFO("Creaza Dummy ACHIZITIONARE SRV----"); return new
	 * AprovizionareImpl();
	 * 
	 * }
	 */
	 ...
	 * logger.loggeazaINFO("Creaza Dummy PERSONAL SRV----"); return new
	 * PersonalImpl();
	 * 
	 * }
	 */
