...
public class TestPersonalImplSimplu {
	...
	Eveniment eveniment2 = new Eveniment(2, "TeamBuilding", 1200.00);
	...
	Candidat candidat2 = new Candidat(2, "adr", "Nume2", "Prenume2", "Dna", 'F', "2880308226771", 102, "Intern");
	...
	DummyPersoanaFizica persoana2 = new DummyPersoanaFizica(3,null,  "Nume2", "Prenume2", null, 'F', null);
	...
	AnuntLocMunca anunt3 = new AnuntLocMunca(2, new String[] { "Internet"}, "Anunt3", functie2, new Date("01/08/2011"), new Date("11/09/2011"));
	AnuntLocMunca anunt2 = new AnuntLocMunca(3, new String[] { "Internet"}, "Anunt2", functie1, new Date("12/09/2011"), new Date("10/12/2011"));
	...
	DosarAngajat dosar2 = new DosarAngajat(1, angajat2, null, null, null);
	...
	CerereDemisie	cerereDemisie1 = new CerereDemisie(1, contract1, new Date("11/08/2011"), null, null,null);
