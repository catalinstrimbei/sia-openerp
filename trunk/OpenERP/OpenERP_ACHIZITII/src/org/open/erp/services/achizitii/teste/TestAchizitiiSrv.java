...
public class TestAchizitiiSrv {
	...
	public void testCerereAprovizionare() throws Exception{
		...
		logger.info("1.Gestiune plan de aprovizionare");
			...
			@Test
			public void testCreareOferta() throws Exception {
				logger.setLevel(Level.DEBUG);
			...
			@Test
			public void testCreareComanda() throws Exception {
				logger.setLevel(Level.DEBUG);
			   ...
			   logger.info("4.Gestiune Comenzii");
				...
				Oferta ofertaFinala = achizitiiInstance.comparare(oferta,oferta2);
				LiniiOferta linieOferta = achizitiiInstance.creareLinieOferta(1, 20.00, mat2, 7.00, ofertaFinala);
			...
			public void testCreareFactura() throws Exception {
			    ...
			    LiniiComanda  linieComanda1 =new LiniiComanda();
			    LiniiComanda linieComanda2 = new LiniiComanda();
