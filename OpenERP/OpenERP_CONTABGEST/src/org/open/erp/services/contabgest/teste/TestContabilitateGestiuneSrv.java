...
public class TestContabilitateGestiuneSrv {
	/* Resurse test*/
	private static Logger logger = Logger.getLogger(TestContabilitateGestiuneSrv.class.getName());
	...
	public void testCreareAnaliza() throws Exception{
		...
		Analiza analiza = contabgestInstance.creareAnaliza("Analiza1", null, null, null, procentRealizare);
