...
public class TestPersonalEJB {
	private static Logger logger = Logger.getLogger(TestPersonalEJB.class.getName());
	private static PersonalSrv instantaPersonal;
	
	
	/* Set up */
	@BeforeClass
	public static void setUpBeforeClass() throws Exception  {try
		{
			instantaPersonal = PersonalSrvFactory.getPersonalSrv();
			logger.info("initTest " + instantaPersonal);
