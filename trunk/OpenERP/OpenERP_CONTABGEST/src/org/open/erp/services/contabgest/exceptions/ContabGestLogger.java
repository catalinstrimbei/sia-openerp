...
public class ContabGestLogger {
	
	private Logger logger;

	public ContabGestLogger() {
		super();
	}
	public static void trace(ContabGestLogger logger_, StackTraceElement e[]) 
	{
	...
	public void log( Level level, Object message_, Throwable t)
	{
		...
		if(level == null || level.equals(Level.DEBUG))
		 ...
		 logger= Logger.getLogger(ContabGestLogger.class.getName());
		 logger.setLevel(Level.ALL);
		 /*
