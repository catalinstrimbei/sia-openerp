...
public class TestAchizitiiEJB {

	/* Resurse test*/
	private static Logger logger = Logger.getLogger(TestAchizitiiEJB.class.getName());
	
	/* Unitatea de test sursa/gazda unitatii de test */
	private static AchizitiiSrv achizitiiInstance;
	
	/* Set up */
	@BeforeClass
	public static void setUpBeforeClass() throws Exception {
		achizitiiInstance = AchizitiiSrvFactory.getAchizitiiSrv();
		logger.info("Initializare Test " + achizitiiInstance);
