...
public interface PersonalSrvLocal extends PersonalSrv{
	 ...
	 */
	Post crearePost(Integer id, String nivelStudii, int salarMinim, Departament dep);
	 ...
	 * 
	 */
	Anunt creareAnunt (Integer id, String titluAnunt, Integer indexCOR, Date dataEmitere, Date dataExpirare, String cerintePost ,Post postLiber);
	 ...
	 * 
	 */
	CV creareCV (Integer id, Candidat titular, List<Tuple<String,Date,Date>> studiiAbsolvite, List<Tuple<String,Date,Date>> functiiOcupate, List<DoubleParam<String,String>> limbiStraine,String aptitudini);
	 ...
	 */	
	ProbaEvaluare creareProbaEvaluare(Integer id, String numeProba);
	 ...
	 * 
	 */
	Interviu creareInterviu(Integer id, Anunt titluAnunt, List<Angajat> numeEvaluatori, List<ProbaEvaluare> probeInterviu, Date dataInterviu);
