...
import org.open.erp.services.vanzari.teste.TestVanzariSrv;
...
public class TestVanzariEJB {
	...
	// Resurse test
		private static Logger logger = Logger.getLogger(TestVanzariSrv.class.getName());
	...
	public static void initLocalJavaLogger(){
		logger =  Logger.getLogger(TestVanzariEJB.class.getName());	
	}
